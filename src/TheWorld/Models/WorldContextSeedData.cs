...
{
    /// <summary>
    /// Make sure that we have some data in our database
    /// </summary>
    public class WorldContextSeedData
    {
        ...
        /// <summary>
        /// We can inject here our WorldContext as a service
        /// </summary>
        ...
        {
            // check async if our test user exists
            ...
            // we do this only if we have no data yet
            if (_context.Trips.Any()) return;

            // add a couple of Trip records
            var usTrip = new Trip()
            {
                Name = "US Trip",
